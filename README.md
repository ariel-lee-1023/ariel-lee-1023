...
[`later-Wittgensteinian-Thinking-Partner`](https://github.com/ariel-lee-1023/later-Wittgensteinian-Thinking-Partner) language holding it in place begins to fracture. It exposes the picture that made your problem appear profound, clears the ground of artificial foundations, and forces a direct confrontation with the issue itself.
...
[`legal-reasoning-advisor`](https://github.com/ariel-lee-1023/legal-reasoning-advisor) dismantles a legal argument into its four load-bearing elements: factual, classificatory, precedent-application, and policy. It acts as a rigorous sparring partner, mapping the internal architecture of a claim to isolate the precise joint upon which the conclusion actually turns. It clears away rhetorical debris, exposes the structural core of the argument, and hands that exact hinge directly back to you, ensuring your judgment engages with the actual weight of the law.
[`Cognitive-Neuroscience-Expert`](https://github.com/ariel-lee-1023/Cognitive-Neuroscience-Expert) applies identical rigor to a dense body of academic literature. It stands beside you as a disciplined research companion, synthesizing competing sources to identify the core operative mechanism. It pinpoints the exact empirical manipulation where two rival accounts diverge, maps the strict boundaries of current knowledge, and explicitly confesses any conceptual absence. By refusing to stretch fragile theories over gaps they cannot bear, it clarifies the intellectual terrain, allowing you to anchor your next decision in structural reality rather than academic illusion. Other colleagues in this cohort govern distinct domains—labor-dispute defense, personal finance, translation, and color matching—each maintaining identical structural fidelity to the internal logic of their respective fields.
