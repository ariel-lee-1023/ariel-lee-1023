...
[`Cognitive-Neuroscience-Expert`](https://github.com/ariel-lee-1023/Cognitive-Neuroscience-Expert) operates as your intellectual navigator through the overwhelming flood of academic literature. It distills complex source material into a unified structural router, identifies the operative cognitive mechanisms, and pinpoints the exact experimental manipulations where divergent accounts collide. It actively maps the boundaries of current knowledge by explicitly confessing conceptual absences. It records deliberate omissions, names the epistemological gaps, and demands further inquiry. It accompanies you in surveying the discipline, guaranteeing that your subsequent theories and research directions are built exclusively upon solid empirical ground.
The rest of the cohort each holds a specific post, maintaining identical structural fidelity to the internal logic of its own field. [`TechLaw-colleague`](https://github.com/ariel-lee-1023/TechLaw-colleague) serves as your colleague in technology law, mapping the institutional power standing behind a rule, refusing efficiency and inevitability as justifications, and locating the exact doctrine upon which the question turns. [`financial-planner`](https://github.com/ariel-lee-1023/financial-planner) acts as your personal financial planner, classifying debt, computing after-tax spreads and net present values, and enforcing liquidity and foundation gates before any optimisation begins—it does not prepare your taxes and it does not pick your stocks. [`English-Chinese-translator`](https://github.com/ariel-lee-1023/English-Chinese-translator) works as a publication-grade Chinese↔English translator, governing the text from above through schema, genre move, register, and cohesion, and delivering the finished translation alone. [`transcript-proofreader`](https://github.com/ariel-lee-1023/transcript-proofreader) stands as your proofreader under edited-verbatim discipline, styling the spoken record without rewording it, correcting mechanics while querying content, and marking every word the editor supplied. [`Color-Matching-Consultant`](https://github.com/ariel-lee-1023/Color-Matching-Consultant) advises as a colour consultant for painting and design, separating perceptual interaction from physical pigment mixing and from cultural association, diagnosing a muddy mix, and refusing false precision while medium and light remain unknown. [`us-study-advisor-for-law-students`](https://github.com/ariel-lee-1023/us-study-advisor-for-law-students) serves as an admissions and career advisor for law students bound for the United States, keeping data, inference, and hunch in separate registers, and never stating a deadline, a tuition figure, or a bar rule from memory. [`toefl-2026-writing-speaking`](https://github.com/ariel-lee-1023/toefl-2026-writing-speaking) sits as an examiner for TOEFL writing and speaking in the 2026 format, scoring against the published rubric rather than against impressions. [`soccer-analyst`](https://github.com/ariel-lee-1023/soccer-analyst) reads matches, clubs, and transfers as a football analyst would—one who had also read the economics.
