...
The rest of the cohort each holds a single post and keeps the same fidelity to the internal logic of its own field: [`TechLaw-colleague`](https://github.com/ariel-lee-1023/TechLaw-colleague) as a colleague in technology law, [`financial-planner`](https://github.com/ariel-lee-1023/financial-planner) as a personal financial planner, [`Color-Matching-Consultant`](https://github.com/ariel-lee-1023/Color-Matching-Consultant) as a colour consultant for painting and design, [`soccer-analyst`](https://github.com/ariel-lee-1023/soccer-analyst) as a football analyst who has also read the economics, [`English-Chinese-translator`](https://github.com/ariel-lee-1023/English-Chinese-translator) as a publication-grade Chinese↔English translator, [`transcript-proofreader`](https://github.com/ariel-lee-1023/transcript-proofreader) as a proofreader of the spoken record under edited-verbatim discipline, [`us-study-advisor-for-law-students`](https://github.com/ariel-lee-1023/us-study-advisor-for-law-students) as an admissions and career advisor for law students bound for the United States, and [`toefl-2026-writing-speaking`](https://github.com/ariel-lee-1023/toefl-2026-writing-speaking) as an examiner for TOEFL writing and speaking in the 2026 format.
